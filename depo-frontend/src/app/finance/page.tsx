...
import { Wallet, AlertCircle, CheckCircle2, CalendarClock } from 'lucide-react';
...
export default function FinancePage() {
    ...
    if (!data) return <AppLayout>Yükleniyor...</AppLayout>;

    return (
        <AppLayout>
            <div className="mb-6"><h1 className="text-2xl font-bold text-slate-900">Finansal Durum</h1><p className="text-sm text-slate-500">Tedarikçi ödemeleri ve nakit akışı takibi.</p></div>
                ...
                <Card className="bg-white border-l-4 border-l-red-500 shadow-sm">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-slate-900 flex items-center gap-2">
                            <Wallet className="text-red-500" /> {data.totalDebt.toLocaleString('tr-TR')} ₺
                        </div>
                    </CardContent>
                </Card>
                <Card className="bg-white border-l-4 border-l-orange-500 shadow-sm">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-orange-600 flex items-center gap-2">
                            <AlertCircle /> {data.overdueAmount.toLocaleString('tr-TR')} ₺
                        </div>
                ...
                <Card className="bg-white border-l-4 border-l-blue-500 shadow-sm">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-blue-600 flex items-center gap-2">
                            <CalendarClock /> {data.unpaidTransactions.length} Adet
                        </div>
                    </CardContent>
                </Card>
            </div>
            ...
            <Card className="shadow-sm border-0">
                ...
                <CardContent className="p-0">
                    <Table>
                        ...
                        <TableBody>
                            {data.unpaidTransactions.length === 0 ? (
